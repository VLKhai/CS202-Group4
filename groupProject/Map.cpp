...
void Map::structEnd(int X, int Y, int iHeight) {
	...
	pFlag = new Flag(X * 32 - 16, Y + iHeight + 72*2 + 30);
...
//	structBonusEnd(353);
//
//	vPlatform.push_back(new Platform(6, 4, 286 * 32 + 16, 355 * 32 + 16, CFG::GameHeight - 16 - 4 * 32, CFG::GameHeight - 16 - 4 * 32, 286 * 32.0f + 16, CFG::GameHeight - 16.0f - 4 * 32, true));
//
//	// -- END
//
//	this->iLevelType = 4;
...
//
//	vPlatform.push_back(new Platform(6, 6, 81 * 32, 81 * 32, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 81 * 32, (float)CFG::GameHeight - 16 - 8 * 32, true, 1));
//	vPlatform.push_back(new Platform(6, 6, 88 * 32, 88 * 32, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 88 * 32, (float)CFG::GameHeight - 16 - 6 * 32, true, 0));
//
//	structSeeSaw(137, 12, 5);
//	vPlatform.push_back(new Platform(6, 6, 136 * 32, 136 * 32, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 136 * 32, (float)CFG::GameHeight - 16 - 9 * 32, true, 3));
//	vPlatform.push_back(new Platform(6, 6, 140 * 32, 140 * 32, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 140 * 32, (float)CFG::GameHeight - 16 - 6 * 32, true, 2));
//	// -- SEESAW
//
//	vPlatform.push_back(new Platform(6, 3, 27 * 32 - 16, 30 * 32 + 16, CFG::GameHeight - 16 - 10 * 32, CFG::GameHeight - 16 - 10 * 32, 27 * 32 - 16, (float)CFG::GameHeight - 16 - 10 * 32, false));
//	vPlatform.push_back(new Platform(6, 3, 30 * 32 - 16, 33 * 32 + 16, CFG::GameHeight - 16 - 6 * 32, CFG::GameHeight - 16 - 6 * 32, 33 * 32 + 16, (float)CFG::GameHeight - 16 - 6 * 32, true));
//	vPlatform.push_back(new Platform(6, 3, 91 * 32 - 32, 94 * 32, CFG::GameHeight - 16 - 5 * 32, CFG::GameHeight - 16 - 5 * 32, 94 * 32, (float)CFG::GameHeight - 16 - 5 * 32, true));
//	vPlatform.push_back(new Platform(6, 3, 92 * 32, 96 * 32, CFG::GameHeight - 16 - 9 * 32, CFG::GameHeight - 16 - 9 * 32, 92 * 32, (float)CFG::GameHeight - 16 - 9 * 32, false));
//	vPlatform.push_back(new Platform(6, 3, 100 * 32 - 16, 103 * 32 + 16, CFG::GameHeight - 16 - 3 * 32, CFG::GameHeight - 16 - 3 * 32, 103 * 32 + 16, (float)CFG::GameHeight - 16 - 3 * 32, true));
//	vPlatform.push_back(new Platform(6, 3, 129 * 32 - 16, 132 * 32 + 16, CFG::GameHeight - 16 - 8 * 32, CFG::GameHeight - 16 - 8 * 32, 132 * 32 + 16, (float)CFG::GameHeight - 16 - 8 * 32, true));
//
//	vPlatform.push_back(new Platform(6, 5, 60 * 32, 60 * 32, CFG::GameHeight - 16 - 8 * 32, CFG::GameHeight - 16 - 8 * 32, 60 * 32, (float)CFG::GameHeight - 16 - 8 * 32, true));
//
//	this->iLevelType = 4;
//}
...
//
//	vPlatform.push_back(new Platform(6, 0, 58 * 32 + 16, 58 * 32 + 16, -32, CFG::GameHeight + 32, 58 * 32 + 16, 9 * 32 + 16, true));
//	vPlatform.push_back(new Platform(6, 0, 58 * 32 + 16, 58 * 32 + 16, -32, CFG::GameHeight + 32, 58 * 32 + 16, 1 * 32 + 16, true));
//
//	vPlatform.push_back(new Platform(6, 0, 114 * 32 + 16, 114 * 32 + 16, -32, CFG::GameHeight + 32, 114 * 32 + 16, 9 * 32 + 16, true));
//	vPlatform.push_back(new Platform(6, 0, 114 * 32 + 16, 114 * 32 + 16, -32, CFG::GameHeight + 32, 114 * 32 + 16, 1 * 32 + 16, true));
//
//	vPlatform.push_back(new Platform(6, 1, 124 * 32, 124 * 32, -32, CFG::GameHeight + 32, 124 * 32, 10 * 32, true));
//	vPlatform.push_back(new Platform(6, 1, 124 * 32, 124 * 32, -32, CFG::GameHeight + 32, 124 * 32, 2 * 32, true));
//
//	vPlatform.push_back(new Platform(6, 0, 156 * 32, 156 * 32, -32, CFG::GameHeight + 32, 156 * 32, 9 * 32 + 16, true));
//	vPlatform.push_back(new Platform(6, 0, 156 * 32, 156 * 32, -32, CFG::GameHeight + 32, 156 * 32, 1 * 32 + 16, true));
//
//	vLevelText.push_back(new LevelText(210 * 32, CFG::GameHeight - 16 - 8 * 32, "WELCOME TO WARP ZONEz"));
//
//	vLevelText.push_back(new LevelText(214 * 32 + 16, CFG::GameHeight - 6 * 32, "5"));
//
//	// -- MAP 4-2-2
//
//	this->iLevelType = 0;
...
//
//	vLevelText.push_back(new LevelText(360 * 32, CFG::GameHeight - 16 - 8 * 32, "WELCOME TO WARP ZONEz"));
//
//	vLevelText.push_back(new LevelText(360 * 32 + 16, CFG::GameHeight - 6 * 32, "8"));
//	vLevelText.push_back(new LevelText(364 * 32 + 16, CFG::GameHeight - 6 * 32, "7"));
//	vLevelText.push_back(new LevelText(368 * 32 + 16, CFG::GameHeight - 6 * 32, "6"));
//
//	for (int i = 0; i < 19; i++) {
...
//	vPlatform.push_back(new Platform(6, 6, 48 * 32, 48 * 32, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 48 * 32, (float)CFG::GameHeight - 16 - 9 * 32, true, 1));
//	vPlatform.push_back(new Platform(6, 6, 55 * 32, 55 * 32, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 55 * 32, (float)CFG::GameHeight - 16 - 6 * 32, true, 0));
//
//	structSeeSaw(81, 12, 9);
//	vPlatform.push_back(new Platform(6, 6, 80 * 32, 80 * 32, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 80 * 32, (float)CFG::GameHeight - 16 - 9 * 32, true, 3));
//	vPlatform.push_back(new Platform(6, 6, 88 * 32, 88 * 32, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 88 * 32, (float)CFG::GameHeight - 16 - 5 * 32, true, 2));
//
//	structSeeSaw(92, 12, 6);
//	vPlatform.push_back(new Platform(6, 6, 91 * 32, 91 * 32, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 91 * 32, (float)CFG::GameHeight - 16 - 9 * 32, true, 5));
//	vPlatform.push_back(new Platform(6, 6, 96 * 32, 96 * 32, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 96 * 32, (float)CFG::GameHeight - 16 - 5 * 32, true, 4));
//
//	structSeeSaw(103, 12, 7);
//	vPlatform.push_back(new Platform(6, 6, 102 * 32, 102 * 32, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 102 * 32, (float)CFG::GameHeight - 16 - 9 * 32, true, 7));
//	vPlatform.push_back(new Platform(6, 6, 108 * 32, 108 * 32, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 108 * 32, (float)CFG::GameHeight - 16 - 5 * 32, true, 6));
//	// -- SEESAW
//
//	vPlatform.push_back(new Platform(6, 2, 58 * 32, 58 * 32, CFG::GameHeight - 16 - 10 * 32, CFG::GameHeight - 64, 58 * 32, (float)CFG::GameHeight - 64, true));
//	vPlatform.push_back(new Platform(6, 2, 62 * 32, 62 * 32, CFG::GameHeight - 12 * 32, CFG::GameHeight - 128, 62 * 32, (float)CFG::GameHeight - 12 * 32, false));
//	vPlatform.push_back(new Platform(6, 2, 136 * 32, 136 * 32, CFG::GameHeight - 16 - 9 * 32, CFG::GameHeight - 48, 136 * 32, (float)CFG::GameHeight - 6 * 32, false));
//
//	structCastleSmall(0, 2);
//
...
//
//	vPlatform.push_back(new Platform(6, 2, 22 * 32, 22 * 32, CFG::GameHeight - 12 * 32, CFG::GameHeight - 16 - 3 * 32, 22 * 32 + 16, (float)CFG::GameHeight - 16 - 4 * 32, true));
//	vPlatform.push_back(new Platform(6, 2, 28 * 32, 28 * 32, CFG::GameHeight - 12 * 32, CFG::GameHeight - 16 - 3 * 32, 28 * 32 + 16, (float)CFG::GameHeight - 12 * 32, false));
//
//	this->iLevelType = 0;
//
//	// -- MAP 5-2-3 BONUS
...
//	structBonusEnd(387);
//
//	vPlatform.push_back(new Platform(6, 4, 341 * 32 + 16, 390 * 32 + 16, CFG::GameHeight - 16 - 4 * 32, CFG::GameHeight - 16 - 4 * 32, 341 * 32.0f + 16, CFG::GameHeight - 16.0f - 4 * 32, true));
//}
...
//	// ---------- LOAD LISTS ----------
//
//	vPlatform.push_back(new Platform(4, 2, 55 * 32, 55 * 32, CFG::GameHeight - 16 - 9 * 32, CFG::GameHeight - 32, 55 * 32, (float)CFG::GameHeight - 32, true));
//
//	vPlatform.push_back(new Platform(4, 3, 83 * 32 - 16, 86 * 32 + 16, CFG::GameHeight - 16 - 6 * 32, CFG::GameHeight - 16 - 6 * 32, 83 * 32 - 16, (float)CFG::GameHeight - 16 - 6 * 32, true));
//
//	vPlatform.push_back(new Platform(4, 3, 91 * 32 - 16, 93 * 32 + 16, CFG::GameHeight - 16 - 5 * 32, CFG::GameHeight - 16 - 5 * 32, 93 * 32 + 16, (float)CFG::GameHeight - 16 - 5 * 32, false));
//
//	vPlatform.push_back(new Platform(4, 3, 127 * 32 - 16, 131 * 32 + 16, CFG::GameHeight - 16 - 8 * 32, CFG::GameHeight - 16 - 8 * 32, 127 * 32 - 16, (float)CFG::GameHeight - 16 - 8 * 32, false));
//
//	// ----- CLOUDS
//
//	structCloud(3, 10, 2);
...
//	structCoins(54, 9, 4, 1);
//
//	vPlatform.push_back(new Platform(4, 2, 22 * 32, 22 * 32, CFG::GameHeight - 12 * 32, CFG::GameHeight - 16 - 3 * 32, 22 * 32 + 16, (float)CFG::GameHeight - 16 - 4 * 32, true));
//	vPlatform.push_back(new Platform(4, 2, 28 * 32, 28 * 32, CFG::GameHeight - 12 * 32, CFG::GameHeight - 16 - 3 * 32, 28 * 32 + 16, (float)CFG::GameHeight - 12 * 32, false));
//
//	// -- MAP 6-2-3
//
//	this->iLevelType = 1;
...
//	structBonusEnd(473);
//
//	vPlatform.push_back(new Platform(6, 4, 406 * 32 + 16, 475 * 32 + 16, CFG::GameHeight - 16 - 4 * 32, CFG::GameHeight - 16 - 4 * 32, 406 * 32.0f + 16, CFG::GameHeight - 16.0f - 4 * 32, true));
//
//	// -- END
//
//	this->iLevelType = 4;
...
//
//	vPlatform.push_back(new Platform(4, 6, 70 * 32 + 16, 70 * 32 + 16, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 70 * 32 + 16, (float)CFG::GameHeight - 16 - 9 * 32, true, 1));
//	vPlatform.push_back(new Platform(4, 6, 74 * 32 + 16, 74 * 32 + 16, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 74 * 32 + 16, (float)CFG::GameHeight - 16 - 5 * 32, true, 0));
//
//	structSeeSaw(79, 12, 4);
//
//	vPlatform.push_back(new Platform(4, 6, 78 * 32 + 16, 78 * 32 + 16, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 78 * 32 + 16, (float)CFG::GameHeight - 16 - 9 * 32, true, 3));
//	vPlatform.push_back(new Platform(4, 6, 81 * 32 + 16, 81 * 32 + 16, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 81 * 32 + 16, (float)CFG::GameHeight - 16 - 5 * 32, true, 2));
//
//	structSeeSaw(127, 12, 4);
//
//	vPlatform.push_back(new Platform(4, 6, 126 * 32 + 16, 126 * 32 + 16, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 126 * 32 + 16, (float)CFG::GameHeight - 16 - 9 * 32, true, 5));
//	vPlatform.push_back(new Platform(4, 6, 129 * 32 + 16, 129 * 32 + 16, CFG::GameHeight - 16, CFG::GameHeight - 16 - 11 * 32, 129 * 32 + 16, (float)CFG::GameHeight - 16 - 5 * 32, true, 4));
//
//	// -- SEESAW
//
//	vPlatform.push_back(new Platform(4, 2, 28 * 32, 28 * 32, CFG::GameHeight - 11 * 32, CFG::GameHeight - 16 - 2 * 32, 28 * 32, (float)CFG::GameHeight - 12 * 32, false));
//
//	vPlatform.push_back(new Platform(4, 3, 39 * 32 + 16, 45 * 32 + 16, CFG::GameHeight - 9 * 32, CFG::GameHeight - 16 - 9 * 32, 39 * 32 + 16, (float)CFG::GameHeight - 9 * 32, false));
//	vPlatform.push_back(new Platform(4, 3, 45 * 32 + 16, 49 * 32 + 16, CFG::GameHeight - 7 * 32, CFG::GameHeight - 16 - 7 * 32, 45 * 32 + 16, (float)CFG::GameHeight - 7 * 32, true));
//	vPlatform.push_back(new Platform(4, 3, 51 * 32, 56 * 32, CFG::GameHeight - 8 * 32, CFG::GameHeight - 16 - 8 * 32, 51 * 32 + 16, (float)CFG::GameHeight - 8 * 32, false));
//
//	vPlatform.push_back(new Platform(4, 2, 60 * 32, 60 * 32, CFG::GameHeight - 11 * 32, CFG::GameHeight - 16 - 2 * 32, 60 * 32, (float)CFG::GameHeight - 12 * 32, false));
//	vPlatform.push_back(new Platform(4, 2, 121 * 32 + 16, 121 * 32 + 16, CFG::GameHeight - 11 * 32, CFG::GameHeight - 16 - 2 * 32, 121 * 32 + 16, (float)CFG::GameHeight - 12 * 32, false));
//
//	vPlatform.push_back(new Platform(4, 5, 141 * 32, 141 * 32, CFG::GameHeight - 16 - 7 * 32, CFG::GameHeight - 16 - 7 * 32, 141 * 32, (float)CFG::GameHeight - 16 - 7 * 32, true));
//	vPlatform.push_back(new Platform(4, 5, 145 * 32, 145 * 32, CFG::GameHeight - 16 - 8 * 32, CFG::GameHeight - 16 - 8 * 32, 145 * 32, (float)CFG::GameHeight - 16 - 8 * 32, true));
...
//
//	vPlatform.push_back(new Platform(4, 5, 18 * 32, 18 * 32, CFG::GameHeight - 16 - 7 * 32, CFG::GameHeight - 16 - 7 * 32, 18 * 32, (float)CFG::GameHeight - 16 - 7 * 32, true));
//	vPlatform.push_back(new Platform(4, 5, 22 * 32, 22 * 32, CFG::GameHeight - 16 - 6 * 32, CFG::GameHeight - 16 - 6 * 32, 22 * 32, (float)CFG::GameHeight - 16 - 6 * 32, true));
//
...
//	addGoombas(54 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(56 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(82 * 32, CFG::GameHeight - 16 - 6 * 32, true);
//	addGoombas(83 * 32 + 16, CFG::GameHeight - 16 - 6 * 32, true);
//	addGoombas(85 * 32, CFG::GameHeight - 16 - 6 * 32, true);
//	addGoombas(94 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(95 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(139 * 32 - 4, CFG::GameHeight - 16 - 6 * 32, true);
//	addGoombas(140 * 32, CFG::GameHeight - 16 - 7 * 32, true);
//	addGoombas(154 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(155 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(157 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//
//	addPlant(32 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(38 * 32 + 16, CFG::GameHeight - 10 - 5 * 32);
//	addPlant(57 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(67 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//	addPlant(103 * 32 + 16, CFG::GameHeight - 10 - 5 * 32);
//
//	addKoppa(25 * 32, CFG::GameHeight - 16 - 2 * 32, 0, true);
//	addKoppa(28 * 32, CFG::GameHeight - 16 - 3 * 32, 0, true);
//	addKoppa(65 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(101 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(149 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(152 * 32, CFG::GameHeight - 16 - 10 * 32, 1, true);
//	addKoppa(165 * 32, CFG::GameHeight - 16 - 2 * 32, 0, true);
//	addKoppa(168 * 32, CFG::GameHeight - 16 - 3 * 32, 0, true);
//	addKoppa(170 * 32, CFG::GameHeight - 16 - 6 * 32, 1, true);
//	addKoppa(171 * 32, CFG::GameHeight - 16 - 2 * 32, 0, true);
//	addKoppa(188 * 32, CFG::GameHeight - 16 - 8 * 32, 1, true);
//	addKoppa(191 * 32, CFG::GameHeight - 16 - 10 * 32, 1, true);
//
//	addHammerBro(113 * 32, CFG::GameHeight - 16 - 7 * 32);
//	addHammerBro(116 * 32, CFG::GameHeight - 16 - 3 * 32);
//}
//
//void Map::loadMinionsLVL_3_2() {
//	clearMinions();
//
//	addKoppa(17 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(33 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(34 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(36 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(43 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(44 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(66 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(78 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(98 * 32, CFG::GameHeight - 16 - 2 * 32, 0, true);
//	addKoppa(111 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(134 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(140 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(141 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(143 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(150 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(151 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(162 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(163 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(165 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(175 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//
//	addGoombas(24 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(25 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(27 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(71 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(72 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(74 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(119 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(120 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(122 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(179 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(180 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(182 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(188 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(189 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(191 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//
//	addPlant(169 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//}
//
//void Map::loadMinionsLVL_3_3() {
//	clearMinions();
//
//	addGoombas(26 * 32, CFG::GameHeight - 16 - 8 * 32, true);
//
//	iLevelType = 3;
//
//	addKoppa(52 * 32, CFG::GameHeight - 16 - 8 * 32, 1, true);
//	addKoppa(54 * 32, CFG::GameHeight - 16 - 4 * 32, 1, true);
//	addKoppa(73 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//
//	addKoppa(114 * 32 - 8, CFG::GameHeight - 16 - 9 * 32, 3, false);
//
//	addKoppa(124 * 32, CFG::GameHeight - 16 - 5 * 32, 1, true);
//	addKoppa(126 * 32, CFG::GameHeight - 16 - 5 * 32, 1, true);
//
//	iLevelType = 4;
//}
//
...
//	addFireBall(54 * 32, CFG::GameHeight - 16 - 9 * 32, 6, rand() % 360, false);
//	addFireBall(64 * 32, CFG::GameHeight - 16 - 3 * 32, 6, rand() % 360, true);
//	addFireBall(64 * 32, CFG::GameHeight - 16 - 9 * 32, 6, rand() % 360, false);
//	addFireBall(80 * 32, CFG::GameHeight - 16 - 3 * 32, 6, rand() % 360, true);
//	addFireBall(80 * 32, CFG::GameHeight - 16 - 9 * 32, 6, rand() % 360, false);
//
...
//	clearMinions();
//
//	addPlant(21 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(116 * 32 + 16, CFG::GameHeight - 10 - 5 * 32);
//	addPlant(132 * 32 + 16, CFG::GameHeight - 10 - 5 * 32);
//	addPlant(163 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//
//	addLakito(26 * 32, CFG::GameHeight - 16 - 11 * 32, 207 * 32);
//}
//
//void Map::loadMinionsLVL_4_2() {
//	clearMinions();
//
//	addGoombas(43 * 32, CFG::GameHeight - 16 - 6 * 32, true);
//	addGoombas(44 * 32 + 16, CFG::GameHeight - 16 - 6 * 32, true);
//	addGoombas(46 * 32, CFG::GameHeight - 16 - 6 * 32, true);
//
//	addKoppa(77 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(100 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(101 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(137 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(168 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(169 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, 1, true);
//
//	addPlant(72 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(78 * 32 + 16, CFG::GameHeight - 10 - 8 * 32);
//	addPlant(84 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(107 * 32 + 16, CFG::GameHeight - 10 - 5 * 32);
//	addPlant(138 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(142 * 32 + 16, CFG::GameHeight - 10 - 5 * 32);
//	addPlant(180 * 32 + 16, CFG::GameHeight - 10 - 8 * 32);
//
//	addBeetle(83 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addBeetle(88 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addBeetle(154 * 32, CFG::GameHeight - 16 - 5 * 32, true);
//	addBeetle(179 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//
//	this->iLevelType = 0;
//
//	addPlant(394 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//
//	this->iLevelType = 1;
//}
//
...
//	this->iLevelType = 3;
//
//	addKoppa(28 * 32 - 2, CFG::GameHeight - 16 - 6 * 32, 1, true);
//	addKoppa(29 * 32, CFG::GameHeight - 16 - 6 * 32, 1, true);
//	addKoppa(39 * 32, CFG::GameHeight - 16 - 3 * 32, 1, true);
//	addKoppa(68 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(78 * 32, CFG::GameHeight - 16 - 10 * 32, 1, true);
//
//	addKoppa(35 * 32, CFG::GameHeight - 16 - 11 * 32, 3, false);
//
//	this->iLevelType = 0;
//}
//
...
//	clearMinions();
//
//	addBowser(167 * 32, CFG::GameHeight - 16 - 6 * 32);
//
...
//	this->iLevelType = 1;
//
//	addPlant(40 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//
//	this->iLevelType = 3;
//}
//
...
//	clearMinions();
//
//	addGoombas(19 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(20 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(22 * 32, CFG::GameHeight - 16 - 2 * 32, true);
...
//	addGoombas(65 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(66 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(68 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(76 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(77 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(103 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(104 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(106 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(121 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(122 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(124 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(135 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(136 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(138 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//
//	addKoppa(16 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(41 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(42 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(61 * 32, CFG::GameHeight - 16 - 3 * 32, 0, true);
//	addKoppa(87 * 32, CFG::GameHeight - 16 - 3 * 32, 0, true);
//	addKoppa(127 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(144 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(145 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(178 * 32, CFG::GameHeight - 16 - 2 * 32, 0, true);
//	addKoppa(182 * 32, CFG::GameHeight - 16 - 6 * 32, 1, true);
//
//	addPlant(44 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(51 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(156 * 32 + 16, CFG::GameHeight - 10 - 7 * 32);
//	addPlant(163 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//
//}
//
...
//	clearMinions();
//
//	addGoombas(143 * 32, CFG::GameHeight - 16 - 4 * 32, true);
//	addGoombas(145 * 32, CFG::GameHeight - 16 - 6 * 32, true);
//	addGoombas(235 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addGoombas(236 * 32 + 16, CFG::GameHeight - 16 - 2 * 32, true);
//
//	addKoppa(103 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(120 * 32, CFG::GameHeight - 16 - 3 * 32, 0, true);
//	addKoppa(186 * 32, CFG::GameHeight - 16 - 4 * 32, 0, true);
//	addKoppa(243 * 32, CFG::GameHeight - 16 - 3 * 32, 0, true);
//	addKoppa(246 * 32, CFG::GameHeight - 16 - 2 * 32, 0, true);
//	addKoppa(266 * 32, CFG::GameHeight - 16 - 7 * 32, 0, true);
//
//	addHammerBro(126 * 32, CFG::GameHeight - 16 - 6 * 32);
//	addHammerBro(161 * 32, CFG::GameHeight - 16 - 7 * 32);
//	addHammerBro(200 * 32, CFG::GameHeight - 16 - 7 * 32);
//	addHammerBro(204 * 32, CFG::GameHeight - 16 - 11 * 32);
//
//	addPlant(135 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(195 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//
//	addBeetle(216 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addBeetle(217 * 32 + 4, CFG::GameHeight - 16 - 2 * 32, true);
//	addBeetle(218 * 32 + 8, CFG::GameHeight - 16 - 2 * 32, true);
//
//	this->iLevelType = 3;
//
//	addKoppa(237 * 32, CFG::GameHeight - 16 - 10 * 32, 1, true);
//
//	this->iLevelType = 0;
//
//	// -- MAP 5-2-2
//
//	addSquid(17 * 32, CFG::GameHeight - 16 - 4 * 32);
//	addSquid(34 * 32, CFG::GameHeight - 16 - 4 * 32);
//	addSquid(43 * 32 + 16, CFG::GameHeight - 16 - 4 * 32);
//
//	addCheep(27 * 32 + 16, CFG::GameHeight - 9 * 32, 0, 1);
//	addCheep(38 * 32 + 28, CFG::GameHeight - 4 * 32, 0, 1);
//	addCheep(48 * 32 + 16, CFG::GameHeight - 6 * 32, 1, 1);
//	addCheep(53 * 32 + 16, CFG::GameHeight - 11 * 32, 0, 1);
//}
//
...
//	addFireBall(92 * 32, CFG::GameHeight - 16 - 4 * 32, 6, rand() % 360, false);
//
//	addFireBall(23 * 32, CFG::GameHeight - 16 - 7 * 32, 12, rand() % 360, true);
//
//	addFireBall(43 * 32, CFG::GameHeight - 16 - 1 * 32, 6, rand() % 360, false);
//	addFireBall(55 * 32, CFG::GameHeight - 16 - 1 * 32, 6, rand() % 360, false);
//	addFireBall(67 * 32, CFG::GameHeight - 16 - 1 * 32, 6, rand() % 360, true);
//
//	addFireBall(103 * 32, CFG::GameHeight - 16 - 3 * 32, 6, rand() % 360, true);
//
//	addUpFire(16 * 32 + 4, 9 * 32);
//	addUpFire(30 * 32, 9 * 32);
//
...
//	this->iLevelType = 0;
//
//	addLakito(23 * 32, CFG::GameHeight - 16 - 11 * 32, 176 * 32);
//
//	addPlant(102 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//
//	this->iLevelType = 4;
//}
//
...
//
//	addKoppa(111 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//	addKoppa(128 * 32, CFG::GameHeight - 16 - 3 * 32, 0, true);
//	addKoppa(291 * 32, CFG::GameHeight - 16 - 11 * 32, 0, true);
//
//	addPlant(104 * 32 + 16, CFG::GameHeight - 10 - 5 * 32);
//	addPlant(113 * 32 + 16, CFG::GameHeight - 10 - 5 * 32);
//	addPlant(117 * 32 + 16, CFG::GameHeight - 10 - 8 * 32);
//	addPlant(120 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//	addPlant(122 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//	addPlant(131 * 32 + 16, CFG::GameHeight - 10 - 5 * 32);
//	addPlant(141 * 32 + 16, CFG::GameHeight - 10 - 6 * 32);
//	addPlant(147 * 32 + 16, CFG::GameHeight - 10 - 7 * 32);
//	addPlant(152 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//	addPlant(165 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(169 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//	addPlant(172 * 32 + 16, CFG::GameHeight - 10 - 7 * 32);
//	addPlant(179 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(190 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//	addPlant(196 * 32 + 16, CFG::GameHeight - 10 - 8 * 32);
//	addPlant(200 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//	addPlant(216 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//	addPlant(220 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//	addPlant(238 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(252 * 32 + 16, CFG::GameHeight - 10 - 8 * 32);
//	addPlant(259 * 32 + 16, CFG::GameHeight - 10 - 5 * 32);
//	addPlant(264 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//	addPlant(266 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(268 * 32 + 16, CFG::GameHeight - 10 - 5 * 32);
//	addPlant(274 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(286 * 32 + 16, CFG::GameHeight - 10 - 5 * 32);
//
//
//	addBeetle(139 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addBeetle(177 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//	addBeetle(205 * 32, CFG::GameHeight - 16 - 10 * 32, true);
//	addBeetle(248 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//
//	addGoombas(152 * 32, CFG::GameHeight - 16 - 10 * 32, true);
//	addGoombas(254 * 32, CFG::GameHeight - 16 - 2 * 32, true);
//
//}
//
...
//	clearMinions();
//
//	addBowser(135 * 32, CFG::GameHeight - 16 - 6 * 32, true);
//
//	addToad(153 * 32, CFG::GameHeight - 3 * 32, false);
//
//	addFireBall(30 * 32, CFG::GameHeight - 16 - 4 * 32, 6, rand() % 360, true);
...
//	addFireBall(88 * 32, CFG::GameHeight - 16 - 10 * 32, 6, rand() % 360, false);
//
//	addFireBall(23 * 32, CFG::GameHeight - 16 - 8 * 32, 6, rand() % 360, true);
//	addFireBall(37 * 32, CFG::GameHeight - 16 - 8 * 32, 6, rand() % 360, true);
//	addFireBall(80 * 32, CFG::GameHeight - 16 - 10 * 32, 6, rand() % 360, false);
//	addFireBall(92 * 32, CFG::GameHeight - 16 - 5 * 32, 6, rand() % 360, true);
//
...
//
//
//	addKoppa(26 * 32, CFG::GameHeight - 16 - 3 * 32, 0, true);
//	addKoppa(44 * 32, CFG::GameHeight - 16 - 4 * 32, 0, true);
//	addKoppa(53 * 32, CFG::GameHeight - 16 - 2 * 32, 0, true);
//	addKoppa(65 * 32, CFG::GameHeight - 16 - 3 * 32, 0, true);
//
//	addKoppa(114 * 32, CFG::GameHeight - 16 - 2 * 32, 1, true);
//
//	addPlant(76 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(93 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(109 * 32 + 16, CFG::GameHeight - 10 - 4 * 32);
//	addPlant(115 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//	addPlant(128 * 32 + 16, CFG::GameHeight - 10 - 3 * 32);
//
//	addHammerBro(85 * 32, CFG::GameHeight - 16 - 7 * 32);
//	addHammerBro(87 * 32, CFG::GameHeight - 16 - 11 * 32);
//	addHammerBro(137 * 32, CFG::GameHeight - 16 - 7 * 32);
//	addHammerBro(135 * 32, CFG::GameHeight - 16 - 3 * 32);
//
//	addBeetle(169 * 32, CFG::GameHeight - 16 - 10 * 32, true);
//}
//
...
//
//	addSquid(22 * 32, CFG::GameHeight - 16 - 3 * 32);
//	addSquid(24 * 32, CFG::GameHeight - 16 - 7 * 32);
//	addSquid(46 * 32, CFG::GameHeight - 16 - 5 * 32);
//	addSquid(52 * 32, CFG::GameHeight - 16 - 7 * 32);
//	addSquid(55 * 32, CFG::GameHeight - 16 - 4 * 32);
//	addSquid(77 * 32, CFG::GameHeight - 16 - 8 * 32);
//	addSquid(83 * 32, CFG::GameHeight - 16 - 6 * 32);
//	addSquid(90 * 32, CFG::GameHeight - 16 - 3 * 32);
//	addSquid(94 * 32, CFG::GameHeight - 16 - 11 * 32);
//	addSquid(105 * 32, CFG::GameHeight - 16 - 3 * 32);
//	addSquid(150 * 32, CFG::GameHeight - 16 - 6 * 32);
//	addSquid(173 * 32, CFG::GameHeight - 16 - 3 * 32);
//	addSquid(179 * 32, CFG::GameHeight - 16 - 3 * 32);
//
//	addCheep(75 * 32 + 28, CFG::GameHeight - 16 - 4 * 32, 0, 1);
//	addCheep(78 * 32 + 28, CFG::GameHeight - 16 - 7 * 32, 0, 1);
//	addCheep(81 * 32 + 28, CFG::GameHeight - 16 - 2 * 32 - 28, 0, 1);
...
//	addCheepSpawner(5 * 32, 200 * 32);
//
//	addKoppa(52 * 32, CFG::GameHeight - 16 - 6 * 32, 0, true);
//	addKoppa(140 * 32, CFG::GameHeight - 16 - 7 * 32, 0, true);
//	addKoppa(156 * 32, CFG::GameHeight - 16 - 5 * 32, 0, true);
//
//	this->iLevelType = 3;
//
//	addKoppa(79 * 32, CFG::GameHeight - 16 - 5 * 32, 1, true);
//	addKoppa(95 * 32, CFG::GameHeight - 16 - 5 * 32, 1, true);
...
//
//	addToad(281 * 32, CFG::GameHeight - 3 * 32, false);
//}
//
